				...
				<div class="container-fluid">
					<form method="POST" action="update_account.php">
						...
						<div class="form-group input-group">
							...
							<input type="email" style="width:350px;" value="<?php echo $srow['username']; ?>" class="form-control" name="username" required>
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon" style="width:150px;">Password:</span>
							<input type="password" style="width:350px;" value="<?php echo $srow['password']; ?>" class="form-control" name="password" readonly >
						</div><hr>
