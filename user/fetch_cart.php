	...
	if(isset($_POST['fcart'])){
		...
		while($row=mysqli_fetch_array($query)){
			...
			<div class="row">
				...
				<div class="col-lg-1">
					<button type="button" class="btn btn-primary btn-sm add_qty" <?php if ($row['product_qty']==0 || ($row['product_qty'] - $row['incart']) < 1) echo 'disabled="disabled"' ;?>  value=" <?php echo $row['productid']; ?>"><i class="fa fa-plus fa-fw"></i></button> 
				</div>
				<div class="col-lg-1">
				...
				<div class="col-lg-1">
					<span style="font-size:11px; position:relative; left:10px; top:3px;"><?php echo $row['size']; ?></span>
				</div>
				<div class="col-lg-1">
